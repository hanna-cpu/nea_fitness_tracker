"""Frontend for the Account Settings page. Backend logic lives in
account_settings_state.py.
"""
    ...
    return rx.vstack(
        ...
        rx.center(
            rx.vstack(
                ...
                # Each field below follows the same "small grey label above
                # an input box" pattern.
                rx.vstack(
